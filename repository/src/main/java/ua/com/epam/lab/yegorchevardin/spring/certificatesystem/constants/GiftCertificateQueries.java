...
public enum GiftCertificateQueries {
    ...
    SELECT_CERTIFICATE_ID("select gc.id from gift_certificates as gc left join gift_certificates_tags as gct on gc.id = gct.gift_certificate_id left join tags as t on t.id = gct.tag_id "),
